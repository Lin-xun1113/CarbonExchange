...
import { Home, FileText, ShoppingBag, User } from 'lucide-react'
...
const GreenLayout = () => {
  ...
  const navItems = [
    { path: '/green', icon: Home, label: '首页' },
    { path: '/green/record', icon: FileText, label: '农事记录' },
    { path: '/green/shop', icon: ShoppingBag, label: '碳积分商城' },
    { path: '/green/profile', icon: User, label: '我的' },
  ]
